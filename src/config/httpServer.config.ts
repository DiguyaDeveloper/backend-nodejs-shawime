...
export async function start() {
  try {
    ...
    const app = createExpressServer({
      ...
      middlewares: [__dirname + '/../api/middlewares/*.middleware.global.ts'],
      development: false,
    ...
    const options = {
      swaggerDefinition: {
        ...
        info: {
          description: 'This is a sample server Shawime server.',
          version: '1.0.0',
          title: 'Swagger Shawime',
...
async function currentUserChecker(action: Action): Promise<Usuario> {
